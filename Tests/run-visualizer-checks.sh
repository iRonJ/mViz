...
xcrun swiftc -module-cache-path /tmp/mViz-swift-cache mViz/Modes/*.swift mViz/Rendering/MotionBlend.swift mViz/Rendering/AudioColor.swift mViz/Rendering/BeatPulse.swift mViz/Audio/LocalTrack.swift mViz/Audio/AudioLevelCurve.swift mViz/Audio/SpectralFluxFollower.swift mViz/Audio/BandAnalyzer.swift "$work_dir/main.swift" -o "$work_dir/checks"
"$work_dir/checks"
